...
(This file is for a MakerBot Thing-O-Matic with an automated build platform)
(and DC Motor Plastruder)
(This file lives at ReplicatorG/machines/thingomatic/start+ABP.gcode)
